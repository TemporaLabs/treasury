...
[**Security → Report a vulnerability**](https://github.com/TemporaLabs/treasury/security/advisories/new)
— a private advisory only the maintainers and you can see. It is enabled on this repository, and it
is the only reporting channel: there is no security mailbox to write to, because an address nobody
is watching is worse than no address at all.
